...
export interface StdAssertionsJsonAbiInterface extends utils.Interface {
  functions: {
...
export interface StdAssertionsJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdAssertionsJsonAbiInterface;
