...
export interface StdInvariantSolStdInvariantAbiInterface
...
export interface StdInvariantSolStdInvariantAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdInvariantSolStdInvariantAbiInterface;
