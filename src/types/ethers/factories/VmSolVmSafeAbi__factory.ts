...
export class VmSolVmSafeAbi__factory {
  static readonly abi = _abi;
  static createInterface(): VmSolVmSafeAbiInterface {
    return new utils.Interface(_abi) as VmSolVmSafeAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VmSolVmSafeAbi {
    return new Contract(address, _abi, signerOrProvider) as VmSolVmSafeAbi;
  }
}
