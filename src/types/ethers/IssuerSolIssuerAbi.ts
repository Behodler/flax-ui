...
export interface IssuerSolIssuerAbiInterface extends utils.Interface {
  functions: {
...
export interface IssuerSolIssuerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IssuerSolIssuerAbiInterface;
