...
export interface StdErrorJsonAbiInterface extends utils.Interface {
  functions: {
...
export interface StdErrorJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdErrorJsonAbiInterface;
