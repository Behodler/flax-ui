...
export interface StdInvariantJsonAbiInterface extends utils.Interface {
  functions: {
...
export interface StdInvariantJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdInvariantJsonAbiInterface;
