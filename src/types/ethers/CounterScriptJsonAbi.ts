...
export interface CounterScriptJsonAbiInterface extends utils.Interface {
  functions: {
...
export interface CounterScriptJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CounterScriptJsonAbiInterface;
