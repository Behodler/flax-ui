...
export interface ICouponSolICouponAbiInterface extends utils.Interface {
  functions: {
...
export interface ICouponSolICouponAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICouponSolICouponAbiInterface;
