...
export interface CouponSolCouponAbiInterface extends utils.Interface {
  functions: {
...
export interface CouponSolCouponAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CouponSolCouponAbiInterface;
