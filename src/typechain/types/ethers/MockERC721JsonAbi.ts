...
export interface MockERC721JsonAbiInterface extends utils.Interface {
  functions: {
...
export interface MockERC721JsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockERC721JsonAbiInterface;
