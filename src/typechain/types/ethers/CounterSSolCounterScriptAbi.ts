...
export interface CounterSSolCounterScriptAbiInterface extends utils.Interface {
  functions: {
...
export interface CounterSSolCounterScriptAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CounterSSolCounterScriptAbiInterface;
