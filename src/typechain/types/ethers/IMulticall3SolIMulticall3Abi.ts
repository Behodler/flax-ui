...
export interface IMulticall3SolIMulticall3AbiInterface extends utils.Interface {
  functions: {
...
export interface IMulticall3SolIMulticall3Abi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMulticall3SolIMulticall3AbiInterface;
