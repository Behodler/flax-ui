...
export interface StdStorageSafeJsonAbiInterface extends utils.Interface {
  functions: {};
...
export interface StdStorageSafeJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdStorageSafeJsonAbiInterface;
