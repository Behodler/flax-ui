...
export interface CounterTSolCounterTestAbiInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_SetNumber(uint256)": FunctionFragment;
    "test_Increment()": FunctionFragment;
  };
...
export interface CounterTSolCounterTestAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CounterTSolCounterTestAbiInterface;
  ...
  callStatic: {
    ...
    test_Increment(overrides?: CallOverrides): Promise<void>;
  };
