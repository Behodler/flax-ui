...
export interface IssuerTestJsonAbiInterface extends utils.Interface {
  functions: {
...
export interface IssuerTestJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IssuerTestJsonAbiInterface;
