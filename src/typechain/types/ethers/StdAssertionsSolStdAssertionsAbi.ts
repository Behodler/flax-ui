...
export interface StdAssertionsSolStdAssertionsAbiInterface
...
export interface StdAssertionsSolStdAssertionsAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdAssertionsSolStdAssertionsAbiInterface;
