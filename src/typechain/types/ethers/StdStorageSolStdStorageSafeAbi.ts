...
export interface StdStorageSolStdStorageSafeAbiInterface
...
export interface StdStorageSolStdStorageSafeAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdStorageSolStdStorageSafeAbiInterface;
