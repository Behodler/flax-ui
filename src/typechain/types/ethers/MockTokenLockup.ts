...
export interface MockTokenLockupInterface extends utils.Interface {
  functions: {
...
export interface MockTokenLockup extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockTokenLockupInterface;
