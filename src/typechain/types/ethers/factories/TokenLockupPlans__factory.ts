...
import type {
  TokenLockupPlans,
  TokenLockupPlansInterface,
} from "../TokenLockupPlans";
...
export class TokenLockupPlans__factory {
  static readonly abi = _abi;
  static createInterface(): TokenLockupPlansInterface {
    return new utils.Interface(_abi) as TokenLockupPlansInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TokenLockupPlans {
    return new Contract(address, _abi, signerOrProvider) as TokenLockupPlans;
  }
}
