...
export interface CouponTestJsonAbiInterface extends utils.Interface {
  functions: {
...
export interface CouponTestJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CouponTestJsonAbiInterface;
