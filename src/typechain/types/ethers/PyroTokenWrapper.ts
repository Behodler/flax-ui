...
export interface PyroTokenWrapperInterface extends utils.Interface {
  functions: {
...
export interface PyroTokenWrapper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PyroTokenWrapperInterface;
