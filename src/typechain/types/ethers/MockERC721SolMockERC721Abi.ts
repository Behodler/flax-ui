...
export interface MockERC721SolMockERC721AbiInterface extends utils.Interface {
  functions: {
...
export interface MockERC721SolMockERC721Abi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockERC721SolMockERC721AbiInterface;
