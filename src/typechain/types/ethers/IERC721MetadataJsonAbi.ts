...
export interface IERC721MetadataJsonAbiInterface extends utils.Interface {
  functions: {
...
export interface IERC721MetadataJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC721MetadataJsonAbiInterface;
