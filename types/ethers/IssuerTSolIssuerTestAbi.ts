...
export interface IssuerTSolIssuerTestAbiInterface extends utils.Interface {
  functions: {
...
export interface IssuerTSolIssuerTestAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IssuerTSolIssuerTestAbiInterface;
