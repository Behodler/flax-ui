...
export interface IMulticall3JsonAbiInterface extends utils.Interface {
  functions: {
...
export interface IMulticall3JsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMulticall3JsonAbiInterface;
