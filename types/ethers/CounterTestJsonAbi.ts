...
export interface CounterTestJsonAbiInterface extends utils.Interface {
  functions: {
...
export interface CounterTestJsonAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CounterTestJsonAbiInterface;
