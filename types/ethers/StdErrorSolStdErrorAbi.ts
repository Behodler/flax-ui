...
export interface StdErrorSolStdErrorAbiInterface extends utils.Interface {
  functions: {
...
export interface StdErrorSolStdErrorAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdErrorSolStdErrorAbiInterface;
