...
export interface ScriptSolScriptAbiInterface extends utils.Interface {
  functions: {
...
export interface ScriptSolScriptAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ScriptSolScriptAbiInterface;
